config = {
    ...
    fuelCostMultiplier = 0.06, -- 2.0 will double the price of fuel and 1.5 will increase it by half.

    useOxTarget = true, -- Set to true to use ox_target for pump interactions instead of 3D text prompts.
    oxTargetDistance = 2.0, -- The interaction distance for ox_target on pumps.
